 ...
 let cantidad = 0
  ...
  controladorDiscos.levantarProductos()
 ...
 // controladorDiscos.agregar(new Product ("Siempre es hoy", 1000, 5, 0, "SEH", "../images/tienda/R-2763752-1459994209-7284.jpg", "Siempre es Hoy: Álbum de 2002, marca la incursión de Cerati en la música electrónica y experimental, con letras introspectivas y atmósferas modernas."))
...
//     let resp = await fetch ("../js/simulador_api.json")
//     let listaProductos = await resp.json()
//     this.mostrarProductosUsuario(listaProductos)
//  }
